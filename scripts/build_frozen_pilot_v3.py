...
def main():
    ...
    rows=v2+added
    out=ROOT/"experiments/frozen_pilot_v3/reference_results.csv"
    ...
    with (ROOT/"experiments/frozen_pilot_v3/reference_backend_coverage.csv").open("w",encoding="utf-8",newline="") as f:
    ...
    (ROOT/"experiments/frozen_pilot_v3/reference_metrics.json").write_text(json.dumps(metrics,indent=2),encoding="utf-8")
