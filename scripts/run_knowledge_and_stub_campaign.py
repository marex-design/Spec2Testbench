...
from knowledge_stub_lib import (
    build_book_enriched_summary,
    build_knowledge_stub_summary,
    run_book_enriched_campaign,
    run_knowledge_and_stub_campaign,
)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the knowledge-base and stub replay campaign")
...
def main() -> None:
    ...
    if args.book_path:
        ...
        run_knowledge_and_stub_campaign(args)
    if args.build_summary:
        print(build_book_enriched_summary() if args.book_path else build_knowledge_stub_summary())
