...
# [Fix 1] Input voltage source (DC for operating point)
circuit.V('in', 'Vin', circuit.gnd, 1.0)
# [Fix 2] Series resistor R1 between Vin and Vout
circuit.R('1', 'Vin', 'Vout', 1@u_kΩ)
# [Fix 3] Series LC branch from Vout to ground for notch
...
# [Fix 4] Output node is 'Vout' by definition above
...
plt.tight_layout()
plt.savefig('sample_design/p13/p13_waveform.png')
...
# 如果任一侧过短，可能是边界阻带问题
min_side_length = max(5, len(gain_db) * 0.05)  # 至少5个点或5%的频率范围
