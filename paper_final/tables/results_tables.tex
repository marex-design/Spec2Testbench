...
\centering
\small
\caption{Nominal ACP-28 execution summary from the reviewer-revision frozen evidence bundle (\texttt{paper\_final/evidence\_freeze\_reviewer\_revision\_20260724/nominal/freeze\_manifest.json}).}
...
\centering
\scriptsize
\caption{Compact nominal outcome table from the reviewer-revision frozen public replay. The full per-circuit table remains available in \texttt{paper\_final/evidence\_freeze\_reviewer\_revision\_20260724/nominal/nominal\_summary.csv}.}
...
\centering
\scriptsize
\caption{Frozen pilot V3 controlled-violation summary retained in the reviewer-revision frozen evidence bundle (\texttt{paper\_final/evidence\_freeze\_reviewer\_revision\_20260724/controlled/frozen\_pilot\_metrics\_v3.json}).}
