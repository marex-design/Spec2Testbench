...
class CircuitType(Enum):
    ...
    def from_analogcoder_task(cls, task_number: int) -> "CircuitType":
        """Map the pinned ACP-28 generation tasks to their actual circuit types.

        This mapping follows AnalogCoder-Pro ``problem_set.tsv`` task IDs 1-28
        rather than the obsolete ordinal mapping that used to live here.
        """
        mapping = {
            1: cls.AMPLIFIER, 2: cls.AMPLIFIER, 3: cls.AMPLIFIER, 4: cls.AMPLIFIER, 5: cls.AMPLIFIER,
            6: cls.AMPLIFIER, 7: cls.AMPLIFIER,
            8: cls.CURRENT_MIRROR,
            9: cls.COMPARATOR,
            10: cls.LOW_PASS_FILTER, 11: cls.HIGH_PASS_FILTER, 12: cls.BAND_PASS_FILTER, 13: cls.NOTCH_FILTER,
            14: cls.AMPLIFIER, 15: cls.AMPLIFIER,
            16: cls.OPERATIONAL_AMPLIFIER,
            17: cls.CURRENT_MIRROR,
            18: cls.OPERATIONAL_AMPLIFIER,
            19: cls.MIXER,
            20: cls.OPERATIONAL_AMPLIFIER, 21: cls.OPERATIONAL_AMPLIFIER,
            22: cls.RC_PHASE_SHIFT_OSCILLATOR, 23: cls.OSCILLATOR,
            24: cls.INTEGRATOR, 25: cls.DIFFERENTIATOR,
            26: cls.COMPOSITE, 27: cls.COMPOSITE,
            28: cls.SCHMITT_TRIGGER,
        }
        if task_number not in mapping:
            raise ValueError(f"Task {task_number} is not in the pinned ACP-28 subset (1-28)")
