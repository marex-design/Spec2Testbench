...
@pytest.mark.parametrize(
    ...
    [
        ("examples/benchmark_specs/p01_amplifier.yaml", "benchmark/analogcoder_pro/p01_amplifier.cir"),
        ("examples/benchmark_specs/p10_lowpass.yaml", "benchmark/analogcoder_pro/p10_lowpass.cir"),
        ("examples/benchmark_specs/p09_comparator.yaml", "benchmark/analogcoder_pro/p09_comparator.cir"),
        ("examples/benchmark_specs/p22_oscillator.yaml", "benchmark/analogcoder_pro/p22_oscillator.cir"),
        ("examples/benchmark_specs/p28_schmitt.yaml", "benchmark/analogcoder_pro/p28_schmitt.cir"),
    ],
)
