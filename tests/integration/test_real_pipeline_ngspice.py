...
CASES = [
    ("p10_lowpass", "benchmark/analogcoder_pro/specs/p10_lowpass.yaml", "benchmark/analogcoder_pro/p10_lowpass.cir"),
    ("p01_amplifier", "benchmark/analogcoder_pro/specs/p01_amplifier.yaml", "benchmark/analogcoder_pro/p01_amplifier.cir"),
    ("p08_currentmirror", "benchmark/analogcoder_pro/specs/p08_currentmirror.yaml", "benchmark/analogcoder_pro/p08_currentmirror.cir"),
    ("p09_comparator", "benchmark/analogcoder_pro/specs/p09_comparator.yaml", "benchmark/analogcoder_pro/p09_comparator.cir"),
    ("p22_oscillator", "benchmark/analogcoder_pro/specs/p22_oscillator.yaml", "benchmark/analogcoder_pro/p22_oscillator.cir"),
]
...
def _run_twice(case_id: str):
    ...
    spec_path = Path(f"benchmark/analogcoder_pro/specs/{case_id}.yaml")
...
def _run_canonical_twice(case_id: str, analysis_key: str):
    ...
    spec_path = ROOT / "benchmark" / "analogcoder_pro" / "specs" / f"{case_id}.yaml"
...
def test_real_pipeline_detects_noncompliant_frozen_variant():
    ...
    report = pipeline.verify_from_yaml(
        Path("experiments/controlled_violations/cases/cv_019_p22_vdd_low/specification.yaml"),
        Path("experiments/controlled_violations/cases/cv_019_p22_vdd_low/mutated_netlist.cir"),
    )
...
def test_ac_gain_is_invariant_to_ac_1_vs_ac_1n(tmp_path):
    ...
    specification = Specification.from_yaml(ROOT / "benchmark" / "analogcoder_pro" / "specs" / "p04_amplifier.yaml")
